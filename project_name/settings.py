...
STATICFILES_DIRS = (
    ...
    os.path.join(SITE_ROOT, '../common-static'),
)
# 
...
SECRET_KEY = 'm!twt7s(lk!bx^=9+f)oh+0-sr$76=6l+h04b5=to12x*_a0+n'
...
AD_DNS_NAME = 'test.ea.it'  # FQDN of your DC (using just the Domain Name to utilize all DC's)
AD_LDAP_PORT=389
AD_LDAP_URL='ldap://%s:%s' % (AD_DNS_NAME,AD_LDAP_PORT)
AD_SEARCH_DN = 'dc=test,dc=ea,dc=it'
AD_NT4_DOMAIN = 'test.ea.it'
